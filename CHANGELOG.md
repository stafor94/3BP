...
- 추적 중인 천체가 흡수·합체·파괴되면 큰 흡수체 여부와 관계없이 일반 추적을 해제하며, 다른 천체나 합체 후손으로 자동 전환하지 않도록 했습니다. 충돌 관찰의 source-lineage tracking은 별도 경로로 계속 유지됩니다.
...
- 항성 합체 연출 시간을 0.09에서 0.12 시뮬레이션초로 늘려 `0.03×` 충돌 관찰에서 약 4초 동안 접촉/흡수 과정을 보여주도록 했습니다.
