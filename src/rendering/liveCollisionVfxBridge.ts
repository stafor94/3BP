...
export const COLLISION_REMNANT_CORE_SCALE_MIN = 0.84
export const COLLISION_REMNANT_CORE_SCALE_MAX = 0.90
export const COLLISION_REMNANT_FORMATION_TARGET_SCALE = 0.98
export const COLLISION_REMNANT_DEFORMATION_START = 0.20
export const COLLISION_REMNANT_DEFORMATION_TRANSFER_END = 0.08
export const COLLISION_REMNANT_COMPRESSION_START = 0.14
export const COLLISION_REMNANT_COMPRESSION_TRANSFER_END = 0.05
